...
const Homepage = () => {
  ...
  const benefits = ["Gecertificeerd en ervaren taxateur", "Uitgebreide gevalideerde rapporten met NWWI-keurmerk", "Scherpe prijzen en snelle service", "Persoonlijke benadering", "Dekking Veenendaal en omstreken"];
