      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                TK Taxaties is opgericht vanuit de passie voor onroerend goed en de behoefte aan 
                eerlijke, professionele taxaties. Met meer dan 15 jaar ervaring in de sector, 
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              {qualifications.map((qual, index) => {
                ...
                return (
                  <Card key={index} className="shadow-card-professional">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { step: "1", title: "Contact", desc: "U neemt contact met ons op" },
              { step: "2", title: "Afspraak", desc: "Wij plannen een inspectie" },
              { step: "3", title: "Taxatie", desc: "Grondige inspectie en analyse" },
              { step: "4", title: "Rapport", desc: "Uitgebreid rapport binnen 5 dagen" }
            ].map((item, index) => (
